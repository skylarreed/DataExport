...
@Component
@StepScope
public class TransactionTypeClassifier implements Classifier<Transaction, ItemWriter<? super Transaction>> {
    ...
    public ItemWriter<? super Transaction> classify(Transaction transaction) {
        String fileName = destination + "/" + "TransactionType-" + transaction.getType() + "-transactions" + ".xml";
        synchronized (this) {
