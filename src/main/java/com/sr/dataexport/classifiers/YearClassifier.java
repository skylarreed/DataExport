...
@Component
@StepScope
public class YearClassifier implements Classifier<Transaction, ItemWriter<? super Transaction>> {
     ...
     * @Description This method classifies the transactions based on the year. It then stores the transactions
    ...
    public ItemWriter<? super Transaction> classify(Transaction transaction) {
        String fileName = destination + "/" + "Year-" + transaction.getYear() + "-transactions" + ".xml";
        synchronized (this) {
